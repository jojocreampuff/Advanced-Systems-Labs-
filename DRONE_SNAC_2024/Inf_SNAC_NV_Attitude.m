...
for i = 1:max_training_loop
    ...
    for j = 1 : N_patterns
        ...
        basis_func(:,j) = basis_2(x_k);
        lambda_k_plus_1 = Attitude_W' * basis_2(x_k);
        ...
        lambda_k_plus_1_target(:,j) = Attitude_Q * (x_k_plus_1) + A_k_plus_1.' * lambda_k_plus_2;
    end
    old_W = Attitude_W;
