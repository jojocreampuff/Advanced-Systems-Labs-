...
load("init_train_params.mat","x_train_init","target_init", "Attitude_Q","Attitude_R")
...
[net,tr] = train(net,x_train_init,target_init,'useParallel','yes', 'useGPU','yes');
e_last = gsubtract(t,y);
...
for i = 1:max_training_loop
    ...
    [net, tr, e, performance] = train_new_network(x_k, lambda_k_plus_1_target);
