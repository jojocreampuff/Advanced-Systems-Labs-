...
// C/C++ source code generated on : Tue Aug 27 15:31:51 2024
//
...
struct B_snac_openloop_SITL_T {
  ...
  real32_T T3;
  real32_T T4;
  real32_T Product2;                   // '<S29>/Product2'
...
struct DW_snac_openloop_SITL_T {
  ...
  real32_T DiscreteTimeIntegrator_DSTATE_i;// '<S9>/Discrete-Time Integrator'
