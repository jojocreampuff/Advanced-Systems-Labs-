function Flex_SNAC_results = simulate_Flex_SNAC_4drone(seed,comm, position, attitude, global_parameters, ref, IC_all, sim_params, Wxyz)
rng(seed);
...
%% different communication pathways
    ...
    if mod(i-1, 10) == 0
        % idx = min(i + 10, size(r_smooth_leader,2));
