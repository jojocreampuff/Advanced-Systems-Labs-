...
AC_c_cost_total(end-1)
% 
% if (add_sensor_noise > 0 || add_actuator_noise > 0) && add_saturation ~=1
%     save("AC_compare_workspace_noise.mat","AC_results")
%     disp("Saving noise only simulation")
% elseif add_saturation == 1
%     save("AC_compare_workspace_noise_saturation.mat","AC_results")
%     disp("Saving noise and saturation simulation")
% else 
%     save("AC_compare_workspace.mat","AC_results")
%     disp("Saving ideal simulation")
% end

% save("AC_IC1.mat","AC_results","W_nominal", "std_div_wind", "heading_nominal", "std_div_wind_heading")
