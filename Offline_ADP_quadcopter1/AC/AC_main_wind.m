...
% make sure these all have the same wind params
% check case list in wind_testing.m
load("ac_pos_wind_2-2.mat","Vk")
Vk_pos = Vk;
load("ac_att_wind_2-2.mat", "Vk")
Vk_att = Vk;
...
save("AC_wind_case_2-2.mat","AC_results")
disp("Saving wind ideal simulation")
