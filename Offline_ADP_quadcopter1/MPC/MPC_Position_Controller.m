function [pos_controls,J_current]=MPC_Position_Controller(current_reference,X,pos_controls,N,J,JN,dt,K,angular_time_constants,decay_rate,alpha,epsilon,W1,W2,b1,b2,mean_inputs,std_inputs,mean_outputs,std_outputs)
...
%% Gradient Descent
    ...
    for k= 1:K
        ...
        for i=1:N
            predicted_acceleration=One_hidden_layer_feedforward(pos_controls(:,i),W1,W2,b1,b2,mean_inputs,std_inputs,mean_outputs,std_outputs);
            predicted_acceleration=acceleration_conversion(predicted_acceleration,yaw);
        ...
        for n=1:N
            for j=1:3
                ...
                for i=n:N
                    predicted_acceleration=One_hidden_layer_feedforward(perturbed_pos_controls(:,i),W1,W2,b1,b2,mean_inputs,std_inputs,mean_outputs,std_outputs);
                    predicted_acceleration=acceleration_conversion(predicted_acceleration,yaw);
