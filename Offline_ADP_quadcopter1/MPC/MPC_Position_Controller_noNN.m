function [pos_controls,J_current]=MPC_Position_Controller_noNN(current_reference,X,pos_controls,N,J,JN,dt,K,angular_time_constants,decay_rate,alpha,epsilon)
