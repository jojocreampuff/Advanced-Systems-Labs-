...
load('infinite_Position_SNAC_workspace2.mat','Position_W','Position_Q','Position_R','Position_F','Position_G','dt','grav')
load('infinite_Attitude_SNAC_workspace2.mat')
dt = 0.004;
...
for i = 1:length(T)
    ...
    U_pos =  -Position_R^-1 * Position_G(pos_error(:,i))' * Position_W' * Basis_Func_84_alberto(pos_error(:,i));
    ...
    torques(:,i) = -Attitude_R^-1 * Attitude_G(Att_error(:,i))' * Attitude_W' * Basis_Func_84_alberto(Att_error(:,i));
    torques(:,i) = torques(:,i);
