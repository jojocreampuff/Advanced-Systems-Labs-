...
load("SNAC_compare_workspace_noise_saturation.mat")
...
%% load PID STUFFAC
load("PID_compare_workspace_noise_saturation.mat")
...
%% load LQR stuff
load("lqr_compare_workspace_noise_saturation.mat")
...
load("AC_compare_workspace_noise_saturation.mat")
...
%% load MPC stuff
load("MPC_compare_workspace_noise_saturation.mat")
...
% z_MPC_MEAN_STD_VAR_error_cost_incost = [MPC_MEAN_STD_VAR_ERROR;
% MPC_MEAN_STD_VAR_cost; MPC_MEAN_STD_VAR_incost];
...
% 
% z_PID_MEAN_STD_VAR_error_cost_incost =
% [PID_MEAN_STD_VAR_ERROR;PID_MEAN_STD_VAR_cost; PID_MEAN_STD_VAR_incost];
...
legend(["$r(t)$", "SNAC", "AC", "LQR"], 'Interpreter', 'latex');
...
ylim([0 5])
legend("SNAC", "AC", "LQR", 'Interpreter', 'latex');
grid on;
...
legend("SNAC Control","AC Control","LQR Control")
grid on;
