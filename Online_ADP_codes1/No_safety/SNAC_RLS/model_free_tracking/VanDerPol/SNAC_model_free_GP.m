%% SNAC Tracking + Drift Learning (Lin-in-Param NN) + GP Residual + SigmaHat
clear; clc; close all;
params = struct();
% --- training ---
params.tf_train   = 900;
params.amp_mult   = 3.5;        % exploration amplitude multiplier
...
% saveFigures("RLS_SNAC_MF_GP")
%% clear super large variables
% clear trainSafe
% clear RLS_SNAC_MF
% save("RLS_SNAC_MF_GP.mat")
%% =====================================================================
%  Local functions
%% =====================================================================
