...
load("SNAC_safe_model_based_barrier_2.mat","Case1_sim","Case2_sim","Case3_sim","bx","by")

% saveFigures("testForEddie")
...
plot(Case3_sim.time(:,1:end-REE), Case3_sim.u(:,1:end-REE),'Color', case3_color, 'LineStyle','-.', 'LineStyle',':');
