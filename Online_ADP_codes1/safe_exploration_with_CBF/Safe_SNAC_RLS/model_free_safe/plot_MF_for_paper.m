...
load("RLS_SNAC_MF_GP_best.mat")
% saveFigures("SAFE_RLS_SNAC_MF_GP_TRAINING")
params.T_sim = 10;
params.dt    = 0.01;
...
plot_training(trainSafe.t',trainSafe.err',trainSafe.theta_hist',"RLS Training",10)
plot_training(trainUnsafe.t',trainUnsafe.err',trainUnsafe.theta_hist',"RLS Training",10)

% plot_GP_drift_stuff(trainSafe,   "Drift Approx  and GP", 200);
