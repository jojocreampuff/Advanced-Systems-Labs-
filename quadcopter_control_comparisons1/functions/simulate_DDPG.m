function DDPG_results = simulate_DDPG(position, attitude, global_parameters, ref, IC, sim_params)
...
% in = in.setVariable('R_pos', R_pos);
% in = in.setVariable('Q_pos', Q_pos);
% in = in.setVariable('R_att', R_att);
% in = in.setVariable('Q_att', Q_att);
...
[tot_cost, track_cost, control_cost] = calculate_cost(DDPG_results.error,DDPG_results.U,Ts_Sim);
DDPG_results.all_cost = [tot_cost, track_cost, control_cost];
